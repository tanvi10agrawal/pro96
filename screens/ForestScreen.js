  ...
  render(){
    return(
      <View style={styles.viewStyle}>
        <ImageBackground source={require('../assets/bgFS.jpg')} style={styles.bg}>
       <View> <Image  source={require('../assets/cibola.jpg')} style={styles.iconImage1}/>
       <Text style={styles.text1} onPress={()=>{Linking.openURL('https://www.fs.usda.gov/cibola')}}> Cibola National Forest </Text>
       <Image source={require('../assets/tongass.jpg')} style={styles.iconImage2}/> 
       <Text style={styles.text2} onPress={()=>{Linking.openURL('https://www.fs.usda.gov/tongass/')}}> Tongass National Forest </Text>
        <Image source={require('../assets/teton.jpg')} style={styles.iconImage3}/>
        <Text style={styles.text3} onPress={()=>{Linking.openURL('https://www.fs.usda.gov/btnf')}}> Bridger-Teton National Forest </Text>
